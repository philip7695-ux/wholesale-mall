 ...
 */
const STEPS = [
  { key: "ORDER_PLACED", labelKey: "statusOrderPlaced", match: ["ORDER_PLACED"], dot: "bg-sky-500", ring: "ring-sky-200", text: "text-sky-600" },
...
export function OrderStatusStepper({
  ...
  const currentIndex = STEPS.findIndex((s) => (s.match as readonly string[]).includes(status))
