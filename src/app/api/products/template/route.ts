...
export async function GET(request: NextRequest) {
  ...
  if (isKids) {
    ...
    const numRows = [
      ["KD001", "유아 반팔티", "유아상의", "부드러운 유아용 반팔티", "면 100%", "블랙", "#000000", 12000, 30, 30, 25, 25, 20, "", "", "", ""],
      ["KD001", "유아 반팔티", "유아상의", "", "", "화이트", "#FFFFFF", 12000, 20, 20, 15, 15, 10, "", "", "", ""],
      ["KD002", "아동 후드티", "아동상의", "", "면 80% 폴리 20%", "네이비", "#001f5b", 18000, "", "", "", "", 50, 40, 30, 20, 10],
    ]
    ...
    // 빈 셀 = 해당 사이즈 없음, 숫자 = 재고 수량
    const adultRows = [
      ["ST001", "기본 반팔티", "상의", "편안한 면 소재 반팔티셔츠", "면 100%", "블랙", "#000000", 15000, 10, 20, 30, 30, 20, 10, 5, ""],
      ["ST001", "기본 반팔티", "상의", "", "", "화이트", "#FFFFFF", 15000, 10, 15, 25, 25, 15, 5, "", ""],
      ["ST002", "데님 팬츠", "하의", "스트레치 데님 팬츠", "면 98% 폴리 2%", "인디고", "#3B5998", 35000, "", 10, 15, 15, 10, 5, "", ""],
      ["ST003", "FREE 원피스", "원피스", "", "폴리 100%", "블랙", "#000000", 28000, "", "", "", "", "", "", "", 100],
    ]
