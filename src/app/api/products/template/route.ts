...
export async function GET(request: NextRequest) {
  ...
  if (isKids) {
    // 시트1: 숫자 사이즈 (80, 85, 90, ...)
    const numRows = [
      ["KD001", "아동 반팔티", "아동상의", "부드러운 아동용 반팔티", "면 100%", "블랙", "#000000", 12000, 30, 30, 25, 25, 20, 15, 10, 10, 5],
      ["KD001", "아동 반팔티", "아동상의", "", "", "화이트", "#FFFFFF", 12000, 20, 20, 15, 15, 10, 10, 5, 5, 0],
      ["KD002", "아동 후드티", "아동상의", "", "면 80% 폴리 20%", "네이비", "#001f5b", 18000, 0, 0, 50, 50, 50, 40, 30, 0, 0],
    ]
    ...
    // 시트2: 영어 사이즈 (F, S, M, L)
    const letterRows = [
      ["KD003", "아동 원피스", "아동원피스", "귀여운 원피스", "폴리 100%", "핑크", "#FF69B4", 15000, 100, 0, 0, 0],
      ["KD004", "아동 티셔츠", "아동상의", "", "면 100%", "블랙", "#000000", 10000, 0, 30, 25, 20],
    ]
    ...
    // 성인복
    const adultRows = [
      ["ST001", "기본 반팔티", "상의", "편안한 면 소재 반팔티셔츠", "면 100%", "블랙", "#000000", 15000, 10, 20, 30, 30, 20, 10, 5, 0],
      ["ST001", "기본 반팔티", "상의", "", "", "화이트", "#FFFFFF", 15000, 10, 15, 25, 25, 15, 5, 0, 0],
      ["ST002", "데님 팬츠", "하의", "스트레치 데님 팬츠", "면 98% 폴리 2%", "인디고", "#3B5998", 35000, 0, 10, 15, 15, 10, 5, 0, 0],
      ["ST003", "FREE 원피스", "원피스", "", "폴리 100%", "블랙", "#000000", 28000, 0, 0, 0, 0, 0, 0, 0, 100],
    ]
