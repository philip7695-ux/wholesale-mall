...
export async function GET(request: NextRequest) {
  ...
  if (isKids) {
    // 시트1: 숫자 사이즈 (80, 85, 90, ...)
    const numRows = [
      ["KD001", "아동 반팔티", "아동상의", "부드러운 아동용 반팔티", "면 100%", "블랙", "#000000", 12000, 30, 30, 25, 25, 20, 15, 10, 10],
      ["KD001", "아동 반팔티", "아동상의", "", "", "화이트", "#FFFFFF", 12000, 20, 20, 15, 15, 10, 10, 5, 5],
      ["KD002", "아동 후드티", "아동상의", "", "면 80% 폴리 20%", "네이비", "#001f5b", 18000, 0, 0, 50, 50, 50, 40, 30, 0],
    ]
