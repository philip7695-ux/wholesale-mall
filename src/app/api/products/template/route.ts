...
const BASE_COL_WIDTHS = [
  ...
  { wch: 25 }, { wch: 12 }, { wch: 12 }, { wch: 10 }, { wch: 10 }, { wch: 8 }, { wch: 10 },
]
...
export async function GET(request: NextRequest) {
  ...
  if (isKids) {
    ...
    const numRows = [
      ["KD001", "유아 반팔티", "유아상의", "BABY", "부드러운 유아용 반팔티", "면 100%", "대한민국", "블랙", "BK", "#000000", "KRW", 12000, 30, 30, 25, 25, 20, "", "", "", ""],
      ["KD001", "유아 반팔티", "유아상의", "BABY", "", "", "", "화이트", "WH", "#FFFFFF", "KRW", 12000, 20, 20, 15, 15, 10, "", "", "", ""],
      ["KD002", "아동 후드티", "아동상의", "KIDS", "", "면 80% 폴리 20%", "베트남", "네이비", "NV", "#001f5b", "USD", 10, "", "", "", "", 50, 40, 30, 20, 10],
    ]
    ...
    // 시트2: 영어 사이즈 (F, S, M, L)
    const letterRows = [
      ["KD003", "아동 원피스", "아동원피스", "KIDS", "귀여운 원피스", "폴리 100%", "중국", "핑크", "PK", "#FF69B4", "CNY", 75, 100, 0, 0, 0],
    ...
    // 빈 셀 = 해당 사이즈 없음, 숫자 = 재고 수량
    const adultRows = [
      ["ST001", "기본 반팔티", "상의", "", "편안한 면 소재 반팔티셔츠", "면 100%", "대한민국", "블랙", "01", "#000000", "USD", 11.5, 10, 20, 30, 30, 20, 10, 5, ""],
      ["ST001", "기본 반팔티", "상의", "", "", "", "", "화이트", "02", "#FFFFFF", "USD", 11.5, 10, 15, 25, 25, 15, 5, "", ""],
      ["ST002", "데님 팬츠", "하의", "", "스트레치 데님 팬츠", "면 98% 폴리 2%", "중국", "인디고", "ID", "#3B5998", "KRW", 35000, "", 10, 15, 15, 10, 5, "", ""],
