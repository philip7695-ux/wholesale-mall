...
export async function GET(request: NextRequest) {
  ...
  if (vertical) {
    ...
    const rows: (string | number)[][] = isKids
      ? [
          ["KD001", "유아 반팔티", "유아상의", "BABY", "면 100%", "대한민국", "블랙", "BK", "KRW", 12000, "80", 30],
          ...
          ["KD003", "아동 원피스", "아동원피스", "KIDS", "폴리 100%", "중국", "핑크", "PK", "CNY", 75, "F", 100],
        ]
      : [
          ["ST001", "기본 반팔티", "상의", "", "면 100%", "대한민국", "블랙", "01", "USD", 11.5, "S", 20],
          ["ST001", "기본 반팔티", "상의", "", "", "", "블랙", "01", "USD", 11.5, "M", 30],
          ["ST001", "기본 반팔티", "상의", "", "", "", "블랙", "01", "USD", 11.5, "L", 30],
          ["ST002", "데님 팬츠", "하의", "", "면 98% 폴리 2%", "중국", "인디고", "ID", "KRW", 35000, "M", 15],
          ["ST003", "FREE 원피스", "원피스", "", "폴리 100%", "", "블랙", "BK", "CNY", 150, "F", 100],
        ]
    ...
    const numRows: (string | number)[][] = [
      ["KD001", "유아 반팔티", "유아상의", "BABY", "면 100%", "대한민국", "블랙", "BK", "KRW", 12000, 30, 30, 25, 25, 20, "", "", "", ""],
      ["KD001", "유아 반팔티", "유아상의", "BABY", "", "", "화이트", "WH", "KRW", 12000, 20, 20, 15, 15, 10, "", "", "", ""],
      ["KD002", "아동 후드티", "아동상의", "KIDS", "면 80% 폴리 20%", "베트남", "네이비", "NV", "USD", 10, "", "", "", "", 50, 40, 30, 20, 10],
    ]
    XLSX.utils.book_append_sheet(wb, buildGridSheet(numRows, KIDS_NUM_SIZES), "아동복(숫자사이즈)")

    // 시트2: 영어 사이즈 (F, S, M, L)
    const letterRows: (string | number)[][] = [
      ["KD003", "아동 원피스", "아동원피스", "KIDS", "폴리 100%", "중국", "핑크", "PK", "CNY", 75, 100, 0, 0, 0],
      ["KD004", "아동 티셔츠", "아동상의", "KIDS", "면 100%", "", "블랙", "BK", "KRW", 10000, 0, 30, 25, 20],
    ]
    ...
    const adultRows: (string | number)[][] = [
      ["ST001", "기본 반팔티", "상의", "", "면 100%", "대한민국", "블랙", "01", "USD", 11.5, 10, 20, 30, 30, 20, 10, 5, ""],
      ["ST001", "기본 반팔티", "상의", "", "", "", "화이트", "02", "USD", 11.5, 10, 15, 25, 25, 15, 5, "", ""],
      ["ST002", "데님 팬츠", "하의", "", "면 98% 폴리 2%", "중국", "인디고", "ID", "KRW", 35000, "", 10, 15, 15, 10, 5, "", ""],
      ["ST003", "FREE 원피스", "원피스", "", "폴리 100%", "", "블랙", "BK", "CNY", 150, "", "", "", "", "", "", "", 100],
    ]
